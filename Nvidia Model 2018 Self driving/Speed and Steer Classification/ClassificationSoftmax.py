...
from utils3Cam2018ClassSoft import INPUT_SHAPE, batch_generator
...
def load_data(args):
    ...
    data_df = pd.read_csv(os.path.join(os.getcwd(), args.data_dir, 'comdataandpixClasses.csv'), names=['index','center' ,'left','right', 'speed' ,'steering' ,'Throttle','brake' , 'Speed_Sequence','Speed_Classes'])
    #yay dataframes, we can select rows and columns by their names
    #we'll store the camera images as our input data
