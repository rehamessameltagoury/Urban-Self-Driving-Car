...
class World(object):
    ...
    def restart(self):
        ...
        while self.player is None:
            transformm = carla.Transform(carla.Location(x=210, y=191, z=5), carla.Rotation(yaw=180))
...
class HUD(object):
    ...
    def tick(self, world, clock):
       ...
       # print((3.6 * math.sqrt(v.x**2 + v.y**2 + v.z**2)))    
        ...
        #Speed_Sequence = Append_Sequence(Speed_Sequence , SSpeed) #this new list is modified recently ! 21/2/2020
        SSteer = c.steer
...
def game_loop(args):
    ...
    try:
        ...
        global data
        xx = client.get_world()
        settings = xx.get_settings()
        settings.synchronous_mode = False 
        xx.apply_settings(settings)
