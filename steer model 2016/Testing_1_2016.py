...
class CameraManager(object):
    ...
    def _parse_image(weak_self, image):
        ...
        if self.recording:
            ...
            #image = utils2016.preprocess(image) # apply the preprocessing
            ...
            #image2 = utils2016.preprocess(image)
            #image2 = np.array(image.row_data)       # the model expects 4D array
            #image.resize(utils2016.INPUT_SHAPE=())
            #image.resize((66,200))
            ...
            # // hsv is the hsv image you want to display
            ...
            steering_angle = float(model.predict(ih, batch_size=1)) #0.7 ,-0.7
...
def main():
    ...
    argparser.add_argument(
        ...
        default='200x66',
        help='window resolution (default: 200x66)')
    argparser.add_argument(
        '--filter',
        metavar='PATTERN',
        default='vehicle.*',
